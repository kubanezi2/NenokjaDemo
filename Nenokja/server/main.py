...
class Chat:
    ...
    def remove_client(self, client):
        print("[[yellow]?[/yellow]] Perdoruesi eshte shkeputur")
        ...
        self.send_to_clients(self.rsa_api.encrypt(
            f"[green]{nickname}[/green] eshte larguar."))
...
class Main:
    ...
    def run():
        ...
        print("[[cyan]+[/cyan]] celsat RSA po krijohen...")
        public_key, private_key = API.create_keys(buffer)
        print("[[cyan]+[/cyan]] Celsat RSA u krijuan me sukses! ")
