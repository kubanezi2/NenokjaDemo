...
""", "center"))
    ...
    def get_username(self):
        username = console.input(
            "[b]Vendos emrin e perdoruesit[/b] :ID: : ")
                    ...
                    if (len(msg_splited[0].strip()) > 0):
                            if msg_splited[0] == "/help":
                                ...
                                try:
                                    ...
                                    print("<[green][i]Ti[/i][/green]>" + " [b]Ngarko: [/b] " + str(upload.url.geturl()))
                                    self.chat_api.send(self.username_styled + " [b]Ngarko:[/b] " + str(upload.url.geturl()))
                                except IndexError:
                                    print("Perdorimi: /upload <folder-i>")
...
class Main:
    ...
    def connect(self):
        ...
        while True:
            try:
                ...
                cls()
                print("[red]Problem[/red]: Lidhja deshtoi! :/ ")
    ...
    def send_username(self, username: str):
        ...
        if confirm != "/accepted":
            print("[red]Problem[/red]: Perdoruesi ekziston :p ")
            s.close()
            quit()
    ...
    def send_password(self, password: str):
        ...
        # Confirm: /exit or /accepted
        if confirm != "/accepted":
            print("[red]Problem[/red]: Fjalkalim i gabuar")
            s.close()
            quit()
